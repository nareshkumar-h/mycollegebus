...
public class UserBoardingDetailDAO {
	...
	public void update(UserBoardingDetail bd) {
		...
		Object[] params = new Object[] { bd.getUser().getId(), bd.getBoardingDetail().getId(), bd.isActive() ,bd.getId() };
